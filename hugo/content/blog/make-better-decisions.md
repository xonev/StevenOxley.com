...
date: 2026-01-23T11:50:44-05:00
hero_image: "/images/left-exit-12.png"
categories:
  - small platform
email_preface: |
  Hi there {{FirstName}},

  It's been a while. I hope 2026 is treating you well. I have been thinking about making decisions lately, and especially how to make better ones. I'm planning to be more intentional about decisions from now on - see the article to find out how I plan to do that.

  You can also read this [on my website]({{ .Page.Permalink }}).

  May you take all the best forks in the road this year.

  Steve Oxley
---

I have given significant thought to how to make good decisions lately. The most recent trigger of these thoughts was a *My First Million* podcast [episode](https://youtu.be/weGrqsbrMgE?si=fEmjI2G3e8frngFt&t=1709). In this episode, one of the hosts - Shaan Puri - shared his "decision survey," which is a list of questions he answers for himself when making a decision. The list of questions itself was interesting and useful (I've created a Google Forms template for them [here](https://docs.google.com/forms/d/1xijYpldR9Ynzxvcz80S7wlV6vq44DZJGeL20Il03TEk/template/preview)). Even more thought-provoking to me was the ensuing discussion between Puri and his cohost about how important making good decisions is. I agree that decision-making is one of the most important and most neglected skills that someone could train. Following are some of the biggest influences on my decision-making lately. Some are from the podcast episode while others are from other sources, including one I bet most of you haven't considered.
...
When searching for that single strong reason, an important place to look is what network effects the decision will precipitate. I was influenced by the work of James Currier in this area, especially his article ["Your Life & Network Effects."](https://www.nfx.com/post/your-life-network-effects) Network effects are the effects that those around us have on our lives. If we surround ourselves with people that like to watch lots of TV and are mostly sedentary, that laziness will likely negatively influence us. Similarly, if we surround ourselves with people who like to work on challenging projects, we'll be inspired to do the same.
...
His approach to making decisions ([quoted here](https://www.georgemuller.org/devotional/how-i-ascertain-the-will-of-god)) includes six steps which all are designed to determine God's will in a situation. In summary, these steps are,
...
- What is the decision? Write it in the length of a tweet.
- What are you feeling? (Fear, greed, anger, vindictive, etc. - if you're feeling any strong negative emotions about this decision, take some time to process those feelings and make the decision later.)
- Are you making this decision from your own will or selfish interest? (If the answer is yes, wait until you can let go of your will and truly desire God's will.)
- What Scripture(s) apply to this decision?
- What providential circumstances are related to this decision?
- How did God respond when you asked His will regarding this decision?
- What is the one strong reason to make this decision? (sum(blended weak reasons) < one strong reason)
- How will this decision affect my network? (Network effects can have more of an impact than any other consideration.)
- What is the strongest reason against making this decision?
- What are the secondary benefits of making the decision?
- If you took the secondary benefits away, would you still make the same decision?
